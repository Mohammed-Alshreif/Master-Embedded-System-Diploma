...
../STM32f103c6_drivers/STM32f103c6_DRIVERS(COM)/I2C_LCD.c \
...
./STM32f103c6_drivers/STM32f103c6_DRIVERS(COM)/I2C_LCD.o \
...
./STM32f103c6_drivers/STM32f103c6_DRIVERS(COM)/I2C_LCD.d \
...
STM32f103c6_drivers/STM32f103c6_DRIVERS(COM)/I2C_LCD.o: ../STM32f103c6_drivers/STM32f103c6_DRIVERS(COM)/I2C_LCD.c
	arm-none-eabi-gcc "$<" -mcpu=cortex-m3 -std=gnu11 -g3 -DSTM32 -DSTM32F1 -DSTM32F103C6Tx -DDEBUG -c -I../Inc -I"C:/E/embedded/test/final simulation code for my assignments/Unit7_MCU_Essential_Peripherals_lesson1_GPIO/timer_interupt/STM32f103c6_drivers/STM32f103c6_DRIVERS(COM)/inc" -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"STM32f103c6_drivers/STM32f103c6_DRIVERS(COM)/I2C_LCD.d" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@"
