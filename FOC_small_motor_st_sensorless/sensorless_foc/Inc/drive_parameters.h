...
#define MIN_APPLICATION_SPEED_RPM       0 /*!< rpm, mechanical,
                                                           absolute value */
#define MEAS_ERRORS_BEFORE_FAULTS       7 /*!< Number of speed
...
#define PLL_KP_GAIN                      466
#define PLL_KI_GAIN                      20
#define PLL_KPDIV     16384
#define PLL_KPDIV_LOG LOG2(PLL_KPDIV)
#define PLL_KIDIV     65535
#define PLL_KIDIV_LOG LOG2(PLL_KIDIV)

#define OBS_MEAS_ERRORS_BEFORE_FAULTS    7  /*!< Number of consecutive errors
...
#define PID_TORQUE_KP_DEFAULT         2605
#define PID_TORQUE_KI_DEFAULT         3379
#define PID_TORQUE_KD_DEFAULT         100
#define PID_FLUX_KP_DEFAULT           2605
#define PID_FLUX_KI_DEFAULT           3379
...
#define PID_SPEED_KP_DEFAULT          3263/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT          672/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
