...
#define PID_TORQUE_KP_DEFAULT         3507
#define PID_TORQUE_KI_DEFAULT         947
#define PID_TORQUE_KD_DEFAULT         100
#define PID_FLUX_KP_DEFAULT           3507
#define PID_FLUX_KI_DEFAULT           947
...
#define OV_VOLTAGE_THRESHOLD_V          32 /*!< Over-voltage
                                                         threshold */
#define UD_VOLTAGE_THRESHOLD_V          11 /*!< Under-voltage
                                                          threshold */
#if 0
