...
#define RS                     0.27 /* Stator resistance , ohm*/
#define LS                     0.000250 /* Stator inductance, H
...
#define NOMINAL_CURRENT         24238
#define MOTOR_MAX_SPEED_RPM     1000 /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT  60.0 /*!< Volts RMS ph-ph /kRPM */
#define ID_DEMAG                -24238 /*!< Demagnetization current */
