...
#define M1_CURR_AMPL_U_Pin GPIO_PIN_4
...
#define DAC_EMUL_CH1_Pin GPIO_PIN_8
#define DAC_EMUL_CH1_GPIO_Port GPIOC
#define DAC_EMUL_CH2_Pin GPIO_PIN_9
#define DAC_EMUL_CH2_GPIO_Port GPIOC
